...
public class ViewSingleKlacht extends Activity implements OnItemSelectedListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.viewsingleklacht);
	...
	class GetProductDetails extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ViewSingleKlacht.this);
				...
				public void run() {
					...
					try {
						...
						if (success == 1) {
							...
							Itelefoonnummer.setVisibility(View.INVISIBLE);
							Imailadres.setVisibility(View.INVISIBLE);
							Ipostcode.setVisibility(View.INVISIBLE);
							Istraatnaam.setVisibility(View.INVISIBLE);
							Iwoonplaats.setVisibility(View.INVISIBLE);
